...
#
# Script generated by Vivado on Thu Sep 18 10:07:24 +0800 2025
...
#
# Usage        : spi_tb.sh
#                spi_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spi_tb.sh [-reset_run]
#                spi_tb.sh [-reset_log]
#                spi_tb.sh [-help]
#
...
# script info
echo -e "spi_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spi_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spi_tb xil_defaultlib.spi_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spi_tb -key {Behavioral:sim_1:Functional:spi_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f593.protoinst" -protoinst "protoinst_files/spi_tb.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spi_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spi_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spi_tb.sh [-help]\n\
Usage: spi_tb.sh [-step]\n\
Usage: spi_tb.sh [-lib_map_path]\n\
Usage: spi_tb.sh [-reset_run]\n\
Usage: spi_tb.sh [-reset_log]\n\
Usage: spi_tb.sh [-keep_index]\n\
Usage: spi_tb.sh [-noclean_files]\n\n\
