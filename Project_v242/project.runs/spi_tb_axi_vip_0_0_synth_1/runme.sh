...
HD_PWD='C:/tmy/0_elta/SPI/Project_v242/project.runs/spi_tb_axi_vip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_tb_axi_vip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_tb_axi_vip_0_0.tcl
